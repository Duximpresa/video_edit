...
def text2speech(text, voice_name, project_name, speech_config, voice_speed):
    print(text)
...
def main():
    ...
    voice_filename = text2speech(text, voice_name, project_name, speech_config, voice_speed)
